"""
helper functions for processing SMILES strings
"""

import re
import numpy as np

from src.util.properties import el_valence, el_metals, el_expand_octet
from src.util.taffi_functions import return_rings, adjmat_to_adjlist
