...
4. Check the contents of the EGAT characterized reactions with `python /path/to/helper/read_pkl.py 3HP_depth1.pkl`
    - The STDOUT should look identical to the contents of `3HP_depth1_read_pkl.out`
