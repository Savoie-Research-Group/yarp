...
el_radii = {  'H':0.39, 'He':0.849,\
              'Li':1.336, 'Be':1.074,                                                                                                                          'B':0.838,  'C':0.757,  'N':0.700,  'O':0.658,  'F':0.668, 'Ne':0.920,\
              'Na':1.539, 'Mg':1.421,                                                                                                                         'Al':1.15,  'Si':1.050,  'P':1.117,  'S':1.064, 'Cl':1.044, 'Ar':1.032,\
              'K' :1.953, 'Ca':1.761, 'Sc':1.8, 'Ti':1.8,  'V':1.8, 'Cr':1.8, 'Mn':1.8, 'Fe':1.8, 'Co':1.8, 'Ni':1.8, 'Cu':1.8, 'Zn':1.8, 'Ga':1.260, 'Ge':1.197, 'As':1.211, 'Se':1.190, 'Br':1.192, 'Kr':1.147,\
              'Rb':2.260, 'Sr':2.052,  'Y':1.8, 'Zr':1.8, 'Nb':1.8, 'Mo':1.8, 'Tc':1.8, 'Ru':1.8, 'Rh':1.8, 'Pd':1.8, 'Ag':1.8, 'Cd':1.8, 'In':1.459, 'Sn':1.398, 'Sb':1.407, 'Te':1.386,  'I':1.382, 'Xe':1.267,\
              'Cs':2.570, 'Ba':2.277, 'La':1.8, 'Hf':1.8, 'Ta':1.8,  'W':1.8, 'Re':1.8, 'Os':1.8, 'Ir':1.8, 'Pt':1.8, 'Au':1.8, 'Hg':1.8, 'Tl':1.518, 'Pb':1.459, 'Bi':1.512, 'Po':1.500, 'At':1.545, 'Rn':1.42,\
              'default' : 0.7 }
'''
# add values for lower case
...
el_max_bonds = {  'H':2,    'He':1,\
                  ...
                  'Cs':None, 'Ba':None, 'La':15, 'Hf':14, 'Ta':13,  'W':12, 'Re':11, 'Os':10, 'Ir':9, 'Pt':8, 'Au':10, 'Hg':None, 'Tl':None, 'Pb':None, 'Bi':None, 'Po':None, 'At':None, 'Rn':None  }
# add values for lower case
