...
#Zhao's note: a simple parser, added myself in Early Feb, when I was still testing reading xyz functionalities of classy-yarp
#Consider using other existing functions in the future
def xyz_parse_simple(xyz,read_types=False, multiple=False):
    """
