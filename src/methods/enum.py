...
from src.core.yarpecule import yarpecule
from src.util.misc import prepare_list, merge_arrays
...
def form_bonds(yarpecules, react=[], hashes=None, inter=False, intra=True, def_only=False, hash_filter=True):
    ...
    hash_filter: bool, default=True
                 ...
                 resolve to distinct hashes, even with this option enabled there may be the appearance of redundant products, 
                 but the isotope placement will be distinct.  
